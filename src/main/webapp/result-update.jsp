...
<!-- Responsive navbar-->
    ...
    <form action="result" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="year" name="year" value="${result.year }" placeholder="Enter Year" class="form-control" required="required" autofocus>
        </div>
        
         <div class="mb-3">
            <label for="seatNo" class="form-label">*SeatNo</label>
            <input type="number" id="seatNo" name="seatNo" value="${result.seatNo }" placeholder="Enter SeatNo" class="form-control" required="required" autofocus>
        </div>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="text" id="grade" name="grade" value="${result.grade }" placeholder="Enter Grade" class="form-control" required="required" autofocus>
        </div>
